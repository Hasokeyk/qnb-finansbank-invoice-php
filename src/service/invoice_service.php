...
use QnbSolutions\QnbEsolutions\enum\document_format;
use QnbSolutions\QnbEsolutions\enum\document_type;
...
class invoice_service
{
    ...
    /**
     * e-Fatura Kayıtlı Kullanıcı listesini base64 zip olarak döndürür.
     */
    ...
    /**
     * e-Fatura gönderir. Dönüş: belgeOID (kuyruk referansı).
     */
    public function belge_gonder_ext(
        ...
        string $belge_turu = 'FATURA_UBL',
        string $belge_versiyon = '1.0',
        ?string $alan_etiket = null,
        ?string $gonderen_etiket = null,
        ?string $xslt_adi = null,
        ?string $xslt_veri_base64 = null,
    ...
    /**
     * Giden belgeleri indirir. Base64 zip döndürür.
     */
    public function giden_belgeleri_indir_ext(
        string $vergi_tc_kimlik_no,
        array $belge_oid_listesi,
        string $belge_turu = 'FATURA',
    ...
    /**
     * Gelen belgeleri indirir. Base64 zip döndürür.
     */
    ...
    /**
     * Hata alan belgeleri tekrar gönderir.
     */
